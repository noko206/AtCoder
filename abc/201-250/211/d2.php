...
function main()
{
	...
	// 前準備
	$q = new SplQueue;
	$q->enqueue(0); // 都市1からスタート
	$dist = array_fill(0, $n, INF32); // 都市1から都市iまでの最短距離
	$dist[0] = 0; // 都市1までの距離は0
	$cnt = array_fill(0, $n, 0); // 都市iまでの最短経路数
	$cnt[0] = 1; // 都市1までの最短経路は1つ
	$mint = new Modint(Modint::MOD1000000007);
